...
const DepositsMovmentReport = () => {
	...
	const { data, refetch, isLoading } = useQuery({
		queryKey: ["depositsMovmentReport", startDate, endDate, station, type],
		queryFn: getDepositsMovmentReport,
		onSuccess: (data) => {
			...
			navigate("./print", {
				state: {
					...
					reportTemplate: "depositsMovmentReport",
				},
			});
		},
		onError: (err) => {
						...
						<CardBody>
							...
							<Row>
								...
								>
									...
									<Radio value="الحركة">الحركة</Radio>
								</RadioGroup>
							</Row>
							<Row>
...
export default DepositsMovmentReport;
