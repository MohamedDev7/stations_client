...
import {
	deleteAnnualStocktaking,
	deleteStocktaking,
	getAllAnnualStocktaking,
	getAllStocktaking,
	getAnnualStocktakingReport,
...
const AnnualStocktakings = () => {
	...
	const { data: stocktakings } = useQuery({
		...
		queryFn: getAllAnnualStocktaking,
		select: (res) => {
			return res.data;
		},
		onSuccess: (data) => {
	...
	const deleteMutation = useMutation({
		mutationFn: deleteAnnualStocktaking,
		onSuccess: (res) => {
	...
	const { data, isLoading } = useQuery({
		queryKey: ["", stocktakingToFetch],
		queryFn: getAnnualStocktakingReport,
		select: (res) => {
		...
		onSuccess: (data) => {
			...
			console.log(`f56oo`, {
				...data,
				info: { ...data.info, min: "00", hr: "00", day: "الثلاثاء" },
			});
			navigate("./print", {
				state: {
					data: {
					...
					reportTemplate: "annualStocktakingReport",
				},
			});
		},
		onError: () => {
...
export default AnnualStocktakings;
