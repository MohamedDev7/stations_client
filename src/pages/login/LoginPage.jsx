						...
						<div className="flex flex-col h-full justify-center gap-5">
							...
							<Input
								endContent={
									...
									>
										{isVisible ? (
											<EyeSlashFilledIcon className="text-2xl text-default-400 pointer-events-none mb-1" />
										) : (
											<EyeFilledIcon className="text-2xl text-default-400 pointer-events-none mb-1" />
										)}
									</button>
								}
								label="كلمة المرور"
